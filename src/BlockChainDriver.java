...
/**
 * Execute commands for the blockchain
 * 
 * @author Candice Lu
  ...
  public static void main(String[] args) throws NoSuchAlgorithmException {
    ...
    while (input.hasNextLine()) {
      if (command.equals("mine")) {
        ...
        pen.println("amount = " + newAmt + ", nonce = "
            + Block.calcNonce(bc.last.contents.getNum() + 1, newAmt, bc.last.contents.getHash()));
        ...
        // append new block
        bc.append(
            new Block(bc.last.contents.getNum() + 1, newAmt, bc.last.contents.getHash(), newNonce));
